...
const DeliverablesPage = () => {
    ...
    const filteredWorkItems = workItems?.filter((workItem: WorkItem) => workItem.workItemType === WorkItemType.Deliverable)
    ...
    return (
        <div className="m-5 p-4">
            ...
            {isLoading ? (<div>Loading deliverables...</div>) : view === "list" ? (
